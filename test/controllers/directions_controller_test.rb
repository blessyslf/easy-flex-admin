...
class DirectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create direction" do
    assert_difference('Direction.count') do
      post directions_url, params: { direction: { content: @direction.content, name: @direction.name, title: @direction.title } }
    end
  ...
  test "should update direction" do
    patch direction_url(@direction), params: { direction: { content: @direction.content, name: @direction.name, title: @direction.title } }
